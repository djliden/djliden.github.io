...
#+DATE: <2021-12-11 Sat>
#+DESCRIPTION: The basics of using Org Babel for R data science tasks, including tabular output and displaying figures as a plain-text alternative to Jupyter.
#+KEYWORDS: Emacs, Org-mode, Org Babel, R, literate programming, data science
...
#+RESULTS:
#+ATTR_HTML: :alt Base R scatter plot of mtcars mpg versus hp with a gridded background, titled Sample Figure
...
#+RESULTS:
#+ATTR_HTML: :alt Wider, shorter Base R scatter plot of mtcars mpg versus hp, titled Sample Figure
...
#+RESULTS:
#+ATTR_HTML: :alt ggplot2 scatter plot of mtcars mpg versus hp with black points on a gray gridded panel
