...
#+DATE: <2024-03-29 Fri>
#+DESCRIPTION: How to retrieve the document files behind the H2O.ai RAG benchmark using their provided scripts, for use as test data in your own RAG work.
#+KEYWORDS: RAG, H2O.ai, LLMs, datasets, retrieval
