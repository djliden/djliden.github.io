...
#+DATE: <2021-02-13>
#+DESCRIPTION: An analysis of urban heat in Las Vegas, mapping temperature by census tract in R with choropleth maps.
#+KEYWORDS: R, urban heat, choropleth maps, census tract, geospatial, Las Vegas
...
#+ATTR_HTML: :alt Raw Landsat raster map of the Las Vegas region shaded green-to-pink by surface temperature in Kelvin
...
#+ATTR_HTML: :alt Rotated choropleth map of Las Vegas census tracts colored by mean surface temperature, titled STtest
...
#+ATTR_HTML: :alt Re-projected choropleth of Las Vegas census tracts shaded blue-to-yellow by mean surface temperature
...
#+ATTR_HTML: :alt Labeled choropleth of Las Vegas census tracts shaded by surface temperature, hotter in the east and south
...
#+ATTR_HTML: :alt Labeled purple choropleth of Las Vegas census tracts shaded by percent of residents below the poverty line
