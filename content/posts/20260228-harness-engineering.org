...
#+IMAGE: /posts/figures/20260228-harness-engineering/social_image.png
...
#+ATTR_HTML: :alt Terminal-Bench leaderboard table; Droid/GPT-5.3-Codex ranks #1 at 77.3%, Claude Opus 4.6 at #4
...
#+ATTR_HTML: :alt Line chart of npm downloads: Claude Code climbs to ~32M vs Codex ~6M over the past year
...
#+ATTR_HTML: :alt MLflow session view for context-harness: turns 1-9 sidebar, token and latency metrics, bash tool-call trace
