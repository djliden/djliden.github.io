...
#+DATE: <2023-03-04 Sat>
#+DESCRIPTION: The basics of calling the OpenAI ChatGPT API from Julia using the HTTP.jl library, with a minimal example to get started.
#+KEYWORDS: Julia, ChatGPT, OpenAI API, HTTP.jl
