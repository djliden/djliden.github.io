...
#+DATE: <2022-07-19 Tue>
#+DESCRIPTION: An introduction to basic plotting in Julia from within Emacs Org mode, building plots incrementally and customizing their visual components.
#+KEYWORDS: Julia, plotting, Emacs, Org-mode, jupyter-julia, data visualization
...
#+ATTR_HTML: :alt Julia Plots.jl curve of the standard normal distribution filled in red, with an unlabeled y1 legend
...
#+ATTR_HTML: :alt Julia plot of the standard normal distribution filled red, titled with x and p(x) axis labels, no legend
...
#+ATTR_HTML: :alt Standard normal distribution plot filled red with larger serif fonts on the title and axis labels
...
#+ATTR_HTML: :alt Julia scatter plot of mtcars horsepower versus MPG on a black background, colored by cylinder count
...
#+ATTR_HTML: :alt Terminal screenshot of a Julia UnicodePlots scatter plot of mtcars MPG versus HP colored by cylinders
