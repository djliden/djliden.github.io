...
#+DATE: <2022-07-24 Sun>
#+DESCRIPTION: Why figures and captions export incorrectly from Org mode by default, and how setting org-html-doctype to html5 fixes it.
#+KEYWORDS: Emacs, Org-mode, HTML export, html5, ox-html
...
#+ATTR_HTML: :alt UnicodePlots scatter plot in a Julia REPL of mtcars MPG vs HP, points colored by cylinder count
