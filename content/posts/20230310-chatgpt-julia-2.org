...
#+DATE: <2023-03-10 Fri>
#+DESCRIPTION: Using a Julia struct and a function to maintain conversation history when working interactively with the ChatGPT API.
#+KEYWORDS: Julia, ChatGPT, OpenAI API, structs
