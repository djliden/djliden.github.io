...
#+DATE: <2022-09-18 Sun>
#+DESCRIPTION: A walkthrough of using jq to download JSON from an API, extract fields based on conditions, and convert the results to CSV.
#+KEYWORDS: jq, JSON, command line, CSV, API, data processing
