#+TITLE: Resources
#+DATE: <2021-12-02 Thu>
#+DESCRIPTION: A collection of resources and reference sites I used as models for building this personal website with Org-mode.
#+KEYWORDS: Emacs, Org-mode, ox-publish, static site, blogging
