...
#+DATE: [2023-06-01 Thu]
#+DESCRIPTION: A roundup of my writing on integrating ChatGPT and other AI tools with Postgres, covering text-to-SQL translation and pgvector search.
#+KEYWORDS: ChatGPT, Postgres, text-to-SQL, pgvector, LLMs
* Background
