...
#+DATE: <2021-05-14>
#+DESCRIPTION: How to train a basic PyTorch model for the Numerai tournament, rebuilding a fastai baseline as a simple PyTorch training loop.
#+KEYWORDS: PyTorch, Numerai, fastai, neural networks, machine learning
...
#+ATTR_HTML: :alt Histogram of simulated Spearman correlations after within-group shuffling, centered near 0.86
