...
#+DATE: <2021-12-03 Fri>
#+DESCRIPTION: How I built this personal website with Org-mode's ox-publish exporter, covering GitHub Pages, CSS theming, sitemaps, and post previews.
#+KEYWORDS: Emacs, Org-mode, ox-publish, GitHub Pages, static site
