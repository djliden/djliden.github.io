...
** TODO [#A] Add navigation buttons to return to the home page/about page/archive page/etc. from any page. (incidentally, if you want to get back home, [[file:../index.org][here's the link]]).
** TODO [#B] Set up a good system for managing images (e.g. for data visualizations from R/Python)
