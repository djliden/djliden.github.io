...
#+AUTHOR: Daniel Liden
#+DATE: <2023-07-09 Sun>
#+DESCRIPTION: How to use YASnippet to build reusable prompt templates with placeholders for the chatgpt-shell package in Emacs.
#+KEYWORDS: Emacs, YASnippet, chatgpt-shell, ChatGPT, prompt templates
* Introduction
#+begin_preview
...
#+ATTR_HTML: :alt Empty Emacs YASnippet new-snippet buffer with mode, name, key, and -- header template lines
...
#+ATTR_HTML: :alt Animation of inserting a YASnippet summary template into an empty chatgpt-shell buffer in Emacs
...
#+ATTR_HTML: :alt Animation of a chatgpt-shell code-explainer snippet yanking Python code from the kill ring in Emacs
