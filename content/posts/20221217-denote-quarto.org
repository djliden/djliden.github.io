...
#+DATE: <2022-12-22 Thu>
#+DESCRIPTION: How to add Quarto (.qmd) files as a custom Denote file type so you can create .qmd notes alongside Org and Markdown.
#+KEYWORDS: Emacs, Denote, Quarto, note-taking, file types
...
#+ATTR_HTML: :alt Emacs minibuffer Denote 'Select file type' prompt listing org, text, quarto, markdown-toml, markdown-yaml
