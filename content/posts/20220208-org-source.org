...
#+DATE:<2022-02-08 Tue> 
#+DESCRIPTION: How to show Org headlines inside Org source blocks by prepending them with a comma so they aren't parsed and exported as real headings.
#+KEYWORDS: Emacs, Org-mode, Org Babel, source blocks
