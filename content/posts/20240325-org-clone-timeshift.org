...
#+DATE: <2024-03-25 Mon>
#+DESCRIPTION: How to use org-clone-subtree-with-time-shift to quickly generate Org headings for recurring tasks with incrementing timestamps.
#+KEYWORDS: Emacs, Org-mode, org-agenda, recurring tasks
