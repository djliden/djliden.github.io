...
#+DATE: <2019-06-14>
#+DESCRIPTION: A review of Andrew Ng's Machine Learning Yearning, a book on setting technical direction for ML projects rather than teaching algorithms.
#+KEYWORDS: machine learning, Andrew Ng, ML strategy, error analysis, book review
